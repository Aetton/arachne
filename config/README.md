...
Служебные `build_id`, `arachne_callback` и `arachne_token` текущий паук не добавляет.
Это старый hub-контракт, оставленный для совместимости. Workflow объявляет только
свои рабочие inputs. Секреты храните в Forgejo secrets, а не в сценарии.
